const ChatResponse = ({response}) => {
    ...
    return (
        <div className="container my-4">
            ...
            {candidates.map((candidate, index) => (
                <div className="card mb-3" key={index}>
                    <div className="card-body">
                        ...
                        <h6>Citations:</h6>
                        <ul>
                            {candidate?.citationMetadata?.citationSources.map((source, index) => (
                                <li key={index}>
            ...
            <p>Promt Tokens: {usageMetadata.promptTokenCount}</p>
            <p>ProResponse Tokens: {usageMetadata.candidateTokenCount}</p>
